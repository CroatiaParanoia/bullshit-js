...
function bullshitGenerator(subject: string, paragraphLength?: number, chapterLength = 6000) {

    function getDiscuss() {
        let words = getSentence(discuss);
    ...
    for (let i = 0; i < (paragraphLength || subject.length); i++) {
        ...
        while (curChapterLength < chapterLength) {
            ...
            if (randomValue < 5 && chapter.length > 200) {
                ...
                curChapterLength = chapterLength + discuss.length;
